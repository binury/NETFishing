...
readonly BUILD_ROOT="${PROJECT_ROOT}/builds/v0.3.3-prealpha"
...
readonly WINDOWS_ZIP="${BUILD_ROOT}/NETfishing-v0.3.3-prealpha-windows-x86_64.zip"
readonly LINUX_ZIP="${BUILD_ROOT}/NETfishing-v0.3.3-prealpha-linux-x86_64.zip"
