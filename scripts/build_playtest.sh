...
readonly BUILD_ROOT="${PROJECT_ROOT}/builds/v0.3.1-prealpha"
...
readonly WINDOWS_ZIP="${BUILD_ROOT}/NETfishing-v0.3.1-prealpha-windows-x86_64.zip"
readonly LINUX_ZIP="${BUILD_ROOT}/NETfishing-v0.3.1-prealpha-linux-x86_64.zip"
