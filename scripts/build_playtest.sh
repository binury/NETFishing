...
readonly BUILD_ROOT="${PROJECT_ROOT}/builds/v0.13.1-alpha"
...
readonly WINDOWS_ZIP="${BUILD_ROOT}/NETfishing-v0.13.1-alpha-windows-x86_64.zip"
readonly LINUX_ZIP="${BUILD_ROOT}/NETfishing-v0.13.1-alpha-linux-x86_64.zip"
